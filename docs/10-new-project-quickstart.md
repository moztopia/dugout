...
This guide adds Dugout command interception to another local project without
copying Dugout files into that project and without modifying its production
runtime.
...
Neither `dug install` nor any build command will create, parse, or rewrite:
