...
TOOL_IMAGES = (
    ...
    "moztopia/dugout-dart:3.12.2",
    "moztopia/dugout-flutter:3.44.2",
)
...
PROXY_HOSTS = (
    ...
    ("minio.localhost", "do_minio", 9001, True),
    ("s3.localhost", "do_minio", 9000, True),
)
...
def validate_answers(username: str, email: str, password: str) -> list[str]:
    errors: list[str] = []
...
def env_contents(username: str, email: str, password: str) -> str:
...
DUGOUT_MINIO_ROOT_USER={username}
DUGOUT_MINIO_ROOT_PASSWORD={password}
...
def cache_paths() -> list[str]:
    ...
    return [
        ...
        str(cache_root / "dart-3.12.2"),
        str(cache_root / "flutter-3.44.2"),
    ]
